use crate::auth::storage::delete_token;
use crate::config::config::Config;
use crate::{
    auth::{
        storage::save_refresh_token,
        utils::{
            check_ownership, get_device_code, get_minecraft_profile, get_minecraft_token,
            get_xbox_token, get_xsts_token, poll_for_ms_token,
        },
    },
    cli::AuthArgs,
